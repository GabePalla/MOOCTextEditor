...
public class DocumentBenchmarking {
	...
	public static void main(String[] args) {
		...
		for (int numToCheck = start; numToCheck < numSteps * increment + start; numToCheck += increment) {
			...
			String charactesFromFile = getStringFromFile(textfile, numToCheck);
			...
			System.out.println(
					numToCheck + "\t" + ((double) (endTimeBasicDocument - startTimeBasicDocument) / 1000000000)
							+ "\t" + ((double) (endTimeEfficientDocument - startTimeEfficientDocument) / 1000000000)
			);
		}
